...
class PoolAssistantStatusSensor(CoordinatorEntity, SensorEntity):
    ...
    def extra_state_attributes(self):
        ...
        return {
            ...
            "chlor_measurement": data.get("chlor_measurement"),
            "chlor_measurement_raw": data.get("chlor_measurement_raw"),
            "ph_measurement": data.get("ph_measurement"),
            "ph_measurement_raw": data.get("ph_measurement_raw"),
            "temp_measurement": data.get("temp_measurement"),
            "temp_measurement_raw": data.get("temp_measurement_raw"),
            "cyanuric_acid_measurement": data.get("cyanuric_acid_measurement"),
            "cyanuric_acid_measurement_raw": data.get("cyanuric_acid_measurement_raw"),
            "ble_measurement": data.get("ble_measurement"),
            "ble_measurement_raw": data.get("ble_measurement_raw"),
            ...
            "chlor_product_type": data.get("chlor_product_type"),
            ...
            "bath_plan_hours": data.get("bath_plan_hours"),
            "bath_plan_until": data.get("bath_plan_until"),
            "bath_plan_set_at": data.get("bath_plan_set_at"),
            "bath_plan_active": data.get("bath_plan_active"),
            ...
            "chlor_pre_target": data.get("chlor_pre_target"),
            "chlor_pre_loss_buffer": data.get("chlor_pre_loss_buffer"),
            ...
            "chlor_retest_window_start": data.get("chlor_retest_window_start"),
            "chlor_retest_window_end": data.get("chlor_retest_window_end"),
