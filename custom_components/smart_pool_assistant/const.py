...
CONF_CHLOR_MIN = "chlor_min"
CONF_CHLOR_MAX = "chlor_max"
CONF_CHLOR_SHOCK_MAX = "chlor_shock_max"
CONF_PH_TARGET = "ph_target"
CONF_PH_MIN = "ph_min"
CONF_PH_MAX = "ph_max"
CONF_CHLOR_PRODUCT_TYPE = "chlor_product_type"
CONF_CHLOR_CONTENT = "chlor_content" # Wirkstoffanteil laut Produktangabe (z.B. 0.56 oder 0.65)
