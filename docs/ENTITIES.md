# Entitaeten und bereitgestellte Sensoren
...
Die Integration stellt unter anderem folgende Entitaeten bereit:
...
Fuer Attributdetails und interne Datenfluesse siehe [../TECHNISCHE_DOKUMENTATION.md](../TECHNISCHE_DOKUMENTATION.md).
