...
- Kein fehlerhafter Service-Aufruf fuer Wetter-Forecasts mehr aus dem Frontend.

## Details

### Forecast-Fix

- Die Lovelace-Karte verwendet fuer das Nachladen von Tagesvorhersagen im Frontend nicht mehr den problematischen Service-Pfad `weather.get_forecasts`.
...
- Bei leerem Ergebnis greift zusaetzlich ein Retry-Cooldown, damit keine sofortige Endlosschleife aus erneuten Forecast-Anfragen entsteht.
