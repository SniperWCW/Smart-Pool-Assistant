...
- `coordinator.py` bleibt die Home-Assistant-Schaltstelle für Refresh, Services, Storage, PoolLab-Abruf und Ergebniszusammenführung.
...
- Fachlogik kann künftig gezielter geändert und getestet werden.
- Änderungen an Dosierlogik oder Wartungshistorie beruehren weniger Home-Assistant-spezifischen Coordinator-Code.
